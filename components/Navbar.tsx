...
export default function Navbar() {
  ...
  return (
    <div className="flex flex-row  bg-gradient-to-r from-fuchsia-100 to-fuchsia-600 shadow-xl justify-between w-full py-3.5 px-[5%] ">
      <div className="flex flex-row justify-between w-full">
        <div className="flex flex-row  items-center text-center w-[25%] gap-3">
            {path != "/" ? (
              <Link href="/">
                <svg
                  ...
                  viewBox="0 0 34 16"
                  fill="none"
                  className="transition-transformhover:bg-btn-background-hover borde"
                >
                  <path
            ...
            <Link href={"https://www.instagram.com/_mattiarotelli__/"} className="text-white" >
              mattiarotelli
            </Link>    
        </div>
        <div className="text-lg justify-between flex flex-row gap-5 text-white">
